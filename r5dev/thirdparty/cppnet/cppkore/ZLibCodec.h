...
{
	// A compression codec that implements the ZLib algo.
	class ZLibCodec
	{
	public:

		// Compress the input buffer using the ZLib codec
		...
		// Decompress the input buffer using the ZLib codec
		...
		// Decompress the input buffer using the ZLib codec (With known output length)

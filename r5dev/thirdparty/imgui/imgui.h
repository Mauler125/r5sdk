...
enum ImGuiInputTextFlags_
{
    ...
    ImGuiInputTextFlags_AutoCaretEnd        = 1 << 21   // Move the input text cursor automatically to the end of the buffer on initial focus.
...
struct ImFontAtlas
{
    ...
    IMGUI_API void              Clear();                    // Clear allPlatformHandleRaw input and output.

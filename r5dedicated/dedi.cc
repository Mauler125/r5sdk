...
void Hooks::DedicatedPatch() {
	...
	*/
	...
	{
		//UI stuff
		//MemoryAddress(0x0000000140275750).Patch({ 0xC3, 0x90, 0x90, 0x90, 0x90 });
	}

	{
		//whaddefuq
		MemoryAddress(0x000000014031CC40).Patch({ 0xC3, 0x90, 0x90, 0x90 });
	...
	// no shader api is broken kids...
	{
		//MemoryAddress(0x000000014044B163 + 1).Patch({ 1 });
	}

	// equals to 0x92A90
	{
		//MemoryAddress(0x1403DF090).Patch({ 0xC3 });
	}

	//return;

	// call to register something...
	{
		constexpr uintptr_t start = 0x00000001403BBBFF; // mov
		//constexpr uintptr_t end = 0x00000001403BBC12; // call
		//MemoryAddress(start).Patch({ 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 }); // who the fuck thought that this is a good idea to not have memset
	}

	// call to check for some material?
	{
		// 0x33, 0xC0, 0x90, 0x90, 0x90, 0x90 - xor eax,eax; nop xIDK
		// 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0xEB
		//MemoryAddress(0x0000000140401CFC).Patch({ 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0xEB });
	}
	...
	// ret patch
	{
		//MemoryAddress(0x1403DEB90).Patch({ 0xC3 });
	}

	// some vfunc in CShaderApi
	{
		//0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90
		//MemoryAddress(0x00000001403DF8EC).Patch({ 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 });
	}
	...
	{
		//MemoryAddress(0x1403B40C0).Patch({ 0xC3 });
	}
